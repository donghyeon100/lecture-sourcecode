...
const deleteOrder = new Set(); // 순서x, 중복x
...
const changeImageFn = (imageInput, order) => {
    ...
    reader.onload = e => {
        ...
        // 이미지가 성공적으로 읽어지면 deleteOrder에서 순서 삭제
...
boardUpdateFrm.addEventListener('submit', e => {
    ...
    // deleteOrder에 저장된 값을 "1,2,3" 형태로 변경해서 저장

    // Array.from(deleteOrder) : Set -> Array 변경
